...
export const UnrealProjects = [
	{
		...
		technicals: [
			...
			"Enemy AI will chase player when in sight, shoot the player every few seconds when in range, search for player within their boundaires when player is out of sight (during the chase), return to their original post when the search fails", 
			"Animations using blend space and state machine",
		...
		challenges: [
			"Adding the animations were tricky as switching between blend space, event graph and state machine got a little confusing", 
			"Writing the enemy AI was complicated as I was introduced to many new concepts like behaviour tree and custom tasks. Had to really take my time in this section.",
			"A shooter game was a lot more complicated than I expected. It took longer than expected but I have learnt to section out the work evenly and take my time as to not overwhelm myself."
		]
	},
	{
		isFlipped: true,
		...
		technicals: [
			...
			"Game mode - eliminate all enemies",
			"Win/Lose screen UI",
			"Visual effects for projectile launching and and hitting a target using the particle system",
	...
	},
	{
		...
		technicals: [
			...
			"Designing puzzles that players have to solve in order to progress the game",
			"Lumin lighting"
		],
		challenges: [
